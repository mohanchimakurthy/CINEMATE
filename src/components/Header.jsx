...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900 px-2 sm:px-4 py-2">
        <div className="flex flex-wrap items-center justify-between items-center mx-auto py-4">
